...
namespace TunicArchipelago {
    public class PaletteEditor : MonoBehaviour {
        ...
        private static void PaletteEditorWindow(int windowID) {
            ...
            bool ToggleCustomTextureUse = GUI.Toggle(new Rect(350f, 370f, 275f, 30f), TunicArchipelago.Settings.UseCustomTexture, "Always Apply Saved Texture");
            TunicArchipelago.Settings.UseCustomTexture = ToggleCustomTextureUse;
