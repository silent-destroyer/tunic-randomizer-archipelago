        ...
        public static void ApplyChestTexture(Chest Chest) {
            if (Chest != null) {
                ...
                if (ItemLookup.ItemList.ContainsKey(ItemId)) {
                    ...
                    if (APItem.Player != Player || !ItemLookup.Items.ContainsKey(APItem.ItemName)) {
            ...
            if (ItemPickup != null && ItemPickup.itemToGive != null) {
                ...
                if (ItemLookup.ItemList.ContainsKey(ItemId)) { 
                    ...
                    if (ItemPositions.SpecificItemPlacement.ContainsKey(ItemPickup.itemToGive.name)) {
                        ...
                        if (Item.Player != Player || !ItemLookup.Items.ContainsKey(Item.ItemName)) {
                            ...
                            } else if (ItemData.Type == ItemTypes.SWORD && (SaveFile.GetInt("randomizer sword progression enabled") == 1)) {
            ...
            if (PagePickup != null) {
                ...
                if (ItemLookup.ItemList.ContainsKey(ItemId)) {
                    ...
                    if (APItem.Player != Player || !ItemLookup.Items.ContainsKey(APItem.ItemName)) {
                        ...
                        } else if (Item.Type == ItemTypes.SWORD && (SaveFile.GetInt("randomizer sword progression enabled") == 1)) {
                            int SwordLevel = SaveFile.GetInt("randomizer sword progression level");
        ...
        public static void SetupRedHexagonPlinth() {
            ...
            if (Plinth != null && ItemLookup.ItemList.ContainsKey(ItemId)) {
                ...
                if (Item.Player != Player || !ItemLookup.Items.ContainsKey(Item.ItemName)) {
                    ...
                    } else if (HexagonItem.Type == ItemTypes.SWORD && (SaveFile.GetInt("randomizer sword progression enabled") == 1)) {
                        int SwordLevel = SaveFile.GetInt("randomizer sword progression level");
        ...
        public static void SwapSiegeEngineCrown() {
            ...
            if (VaultKey != null && ItemLookup.ItemList.ContainsKey(ItemId)) {
                ...
                if (Item.Player != Player || !ItemLookup.Items.ContainsKey(Item.ItemName)) {
                    ...
                    } else if (VaultKeyItem.Type == ItemTypes.SWORD && (SaveFile.GetInt("randomizer sword progression enabled") == 1)) {
                        int SwordLevel = SaveFile.GetInt("randomizer sword progression level");
            ...
            if (ItemLookup.ItemList.ContainsKey(ItemId)) {
                ...
                if (APItem.Player != Player || !ItemLookup.Items.ContainsKey(APItem.ItemName)) {
                    ...
                    if (NewItem.GetComponent<Rotate>() == null) {
                        ...
                        if (Item.ItemNameForInventory == "Sword Progression" && (SaveFile.GetInt("randomizer sword progression level") == 0 || SaveFile.GetInt("randomizer sword progression level") == 3)) {
        ...
        public static void SetupDathStoneItemPresentation() {
            if (!DathStonePresentationAlreadySetup) {
                try {
                    ...
                    KeySpecial.GetComponent<SpriteRenderer>().color = new UnityEngine.Color(1f, 1f, 1f, 0.5f);
